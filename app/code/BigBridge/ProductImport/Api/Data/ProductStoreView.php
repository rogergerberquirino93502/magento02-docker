...
class ProductStoreView
{
    ...
    public function setSocialLike(string $name = null)
    {
        $this->attributes[self::ATTR_SOCIAL_LIKE] = ($name === null) ? null : trim($name);
    }

    public function getSocialLike()
    {
        return array_key_exists(self::ATTR_SOCIAL_LIKE, $this->attributes) ? $this->attributes[self::ATTR_SOCIAL_LIKE] : null;
    }

    public function setSocialQuantity(string $name = null)
    {
        $this->attributes[self::ATTR_SOCIAL_QUANTITY] = ($name === null) ? null : trim($name);
    }
